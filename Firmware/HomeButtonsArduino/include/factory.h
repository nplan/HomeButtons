            ...
            if (cmd == 'T') {
                ...
                if (
                    ...
                    log_i("settings:\n\
                           ...
                           hw version: %s\n\
                           unique_id: %s\n",
                           settings.serial_number.c_str(),
                           settings.random_id.c_str(),
